...
The Seeed Studio version acts like a usb drive. When you double press reset, it shows up on the explorer and allows you to drag .uf2 files to it. These are not generated by the examples.
> [!Caution]
...
```
I pulled the .uf2 into my nrf52840 and now, I cannot even flash a blinky sketch anymore.
My guess to what happened is, that I did never define how this uf2 file is supposed to be structured.
